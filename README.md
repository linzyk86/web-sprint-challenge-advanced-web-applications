...
It's for authentication, to show if a user is logged in or not.

2. What steps can you take in your web apps to keep your data secure?

Use authentication with tokens, and use protected routes.

3. Describe how web servers work.

When you send an http request, it goes to the server, where the wesbite is hosted, then the server sends the website back
